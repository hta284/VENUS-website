      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
          ...
          >
            ...
            <h3 className="font-serif text-2xl font-bold mb-2">Dầu Gội CocoVenus</h3>
            <p className="text-brand-brown/70 mb-4 px-4 h-12 line-clamp-2">Dưỡng ẩm sâu, kích thích mọc tóc</p>
            <div className="text-sm border-t border-b border-brand-green/10 py-3 w-full mb-6">
              <span className="font-medium text-brand-green">Thành phần:</span> Dầu Dừa Bến Tre + Tinh Dầu Bưởi
            </div>
            <div className="text-2xl font-bold mb-6 text-brand-green">145.000 ₫</div>
            <button className="w-full bg-brand-green text-white hover:bg-brand-green-dark py-3 rounded-full font-medium transition-colors flex items-center justify-center gap-2 mt-auto">
          ...
          >
            ...
            <h3 className="font-serif text-2xl font-bold mb-2">Combo Gội & Xả</h3>
            <p className="text-brand-brown/70 mb-4 px-4 h-12 flex items-center justify-center">Giải pháp mềm mượt & kích mọc tóc hoàn hảo</p>
            
            <div className="flex flex-col items-center w-full mb-6">
              <span className="text-gray-400 line-through text-sm">290.000 ₫</span>
              <div className="text-3xl font-bold text-brand-green">245.000 ₫</div>
            </div>
            
            <button className="w-full bg-brand-gold text-brand-brown hover:bg-yellow-500 py-3.5 rounded-full font-bold transition-colors flex items-center justify-center gap-2 mt-auto shadow-md">
          ...
          >
            ...
            <h3 className="font-serif text-2xl font-bold mb-2">Dầu Xả CocoVenus</h3>
            <p className="text-brand-brown/70 mb-4 px-4 h-12 line-clamp-2">Mềm mượt tức thì, dễ chải gỡ</p>
            <div className="text-sm border-t border-b border-brand-green/10 py-3 w-full mb-6">
              <span className="font-medium text-brand-green">Thành phần:</span> Dầu Dừa + Dưỡng chất phục hồi
            </div>
            <div className="text-2xl font-bold mb-6 text-brand-green">145.000 ₫</div>
            <button className="w-full bg-brand-green text-white hover:bg-brand-green-dark py-3 rounded-full font-medium transition-colors flex items-center justify-center gap-2 mt-auto">
              <ShoppingCart className="w-4 h-4" />
